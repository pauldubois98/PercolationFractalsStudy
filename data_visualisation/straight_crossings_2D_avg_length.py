...
plt.xlim(0,1)
plt.ylim(0.9,2.25)
plt.savefig("imgs/straight_crossing_length_2D.png")
plt.show()
...
plt.xlim(0,1)
plt.ylim(0.9,2.25)
plt.savefig("imgs/straight_crossing_length_2D_bis.png")
plt.show()
...
plt.xlim(0,1)
plt.ylim(0.9,2.25)
plt.savefig("imgs/straight_crossing_length_2D_ter.png")
plt.show()
