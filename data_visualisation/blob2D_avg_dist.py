...
plot_set(3, 5, 1,0,1)
plot_set(5, 2, 1,1,0)
plt.title("Maximum distance to the center of the blob")
plt.xlabel("p")
plt.ylabel("Average maximum distance to the center")
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.subplots_adjust(left=0.1, right=0.75, top=0.9, bottom=0.1)
plt.xlim(0,1)
plt.ylim(0,0.5*(2**0.5))
plt.savefig("imgs/blob_2D/blob_dist_2D.png")
plt.show()
...
plt.xlim(0,1)
plt.ylim(0,0.5*(2**0.5))
plt.savefig("imgs/blob_2D/blob_dist_2D_bis.png")
plt.show()
...
plt.xlim(0,1)
plt.ylim(0,0.5*(2**0.5))
plt.savefig("imgs/blob_2D/blob_dist_2D_ter.png")
plt.show()
