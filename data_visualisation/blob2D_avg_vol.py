...
plt.xlim(0,1)
plt.ylim(0,1)
plt.savefig("imgs/blob_2D/blob_vol_2D.png")
plt.show()
...
plt.xlim(0,1)
plt.ylim(0,1)
plt.savefig("imgs/blob_2D/blob_vol_2D_bis.png")
plt.show()
...
plt.xlim(0,1)
plt.ylim(0,1)
plt.savefig("imgs/blob_2D/blob_vol_2D_ter.png")
plt.show()
...
plt.xlim(0,1)
plt.ylim(0,1)
plt.savefig("imgs/blob_2D/blob_vol_2D_qua.png")
plt.show()
