...
plt.xlim(0,1)
#plt.xlim(0.6,1)
plt.savefig("imgs/crossing_2D/straight_crossing_proba_2D.png")
plt.show()
...
plt.xlim(0,1)
#plt.xlim(0.6,1)
plt.savefig("imgs/crossing_2D/straight_crossing_proba_2D_bis.png")
plt.show()
...
plt.xlim(0,1)
#plt.xlim(0.6,1)
plt.savefig("imgs/crossing_2D/straight_crossing_proba_2D_ter.png")
plt.show()
