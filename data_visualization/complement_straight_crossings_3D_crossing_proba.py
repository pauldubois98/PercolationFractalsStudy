...
plt.xlim(0,1)
#plt.xlim(0.6,1)
plt.savefig("data_visualization/crossing_3D/complement_straight_crossing_proba_3D.png", dpi=300)
plt.show()
...
plt.xlim(0,1)
#plt.xlim(0.6,1)
plt.savefig("data_visualization/crossing_3D/complement_straight_crossing_proba_3D_bis.png", dpi=300)
plt.show()
